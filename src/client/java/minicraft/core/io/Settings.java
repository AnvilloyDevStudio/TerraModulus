...
public final class Settings {
	...
	static {
		...
		options.put("hwa", new BooleanEntry(new Localization.HookedLocalizedBufArgString("minicraft.settings.opengl_hwa"), !FileHandler.OS.contains("windows")));

		options.put("size", new ArrayEntry<>(new Localization.HookedLocalizedBufArgString("minicraft.displays.world_create.options.world_size"), 128, 256, 512));
		options.put("theme", new ArrayEntry<>(new Localization.HookedLocalizedBufArgString("minicraft.displays.world_create.options.theme"), "minicraft.displays.world_create.options.theme.normal", "minicraft.displays.world_create.options.theme.forest", "minicraft.displays.world_create.options.theme.desert", "minicraft.displays.world_create.options.theme.plain", "minicraft.displays.world_create.options.theme.hell"));
		options.put("type", new ArrayEntry<>(new Localization.HookedLocalizedBufArgString("minicraft.displays.world_create.options.terrain_type"), "minicraft.displays.world_create.options.terrain_type.island", "minicraft.displays.world_create.options.terrain_type.box", "minicraft.displays.world_create.options.terrain_type.mountain", "minicraft.displays.world_create.options.terrain_type.irregular"));

		options.put("tutorials", new BooleanEntry(new Localization.HookedLocalizedBufArgString("minicraft.displays.world_create.options.tutorials"), false));
		options.put("quests", new BooleanEntry(new Localization.HookedLocalizedBufArgString("minicraft.displays.world_create.options.quests"), false));
