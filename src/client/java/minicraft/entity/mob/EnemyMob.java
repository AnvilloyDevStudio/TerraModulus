...
public class EnemyMob extends MobAi {
	...
	public int lvl;
	protected SpriteLink[][][] lvlSprites;
	 ...
	 * @param rwChance The chance of this mob will walk in a random direction (random walk chance)
	 */
	public EnemyMob(int lvl, SpriteLink[][][] lvlSprites, int health, boolean isFactor, int detectDist, int rwTime, int rwChance) {
	 ...
	 * @param detectDist The distance where the mob will detect the player and start moving towards him/her.
	 */
	public EnemyMob(int lvl, SpriteLink[][][] lvlSprites, int health, int detectDist) {
